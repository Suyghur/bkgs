...
abstract class BaseLivePlayer extends VodPlayer {
    ...
    public void setBufferSize(int size) {
        synchronized (lock) {
            if (player != null) {
                ...
                LogUtil.info("set buffer size " + size);
            }
        }
    }
    ...
    public void switchContentUrl(String newVideoPath, DataSourceConfig config) {
        LogUtil.info("switchContentUrl switching video path to " + newVideoPath);
    ...
    private void newSwitchContentUrl(String newVideoPath, DataSourceConfig config) {
        synchronized (lock) {
            if (player != null) {
                ...
                LogUtil.info("switch content url with data source config " + newVideoPath);
            }
        }
    }
    ...
    public void setAutoRetryConfig(AutoRetryConfig config) {
        synchronized (lock) {
            ...
            LogUtil.info("set auto retry config: " + config);
        }
    }
