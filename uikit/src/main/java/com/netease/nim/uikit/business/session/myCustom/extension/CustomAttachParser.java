...
//                    attachment = new RTSAttachment();
                ...
                case CustomAttachmentType.RedPacket:
                    ...
                    break;
                case CustomAttachmentType.subscribe:
                    attachment = new ReservationMsgAttachment();
                    break;
...
//                    attachment = new RedPacketOpenedAttachment();
                ...
                case CustomAttachmentType.MultiRetweet:
                    ...
                    break;
                case CustomAttachmentType.operation:
                    attachment = new AnchorsPperation();
                    break;
                case CustomAttachmentType.SystemMsg:
                    attachment = new SystemAttachment();
                    break;
                case CustomAttachmentType.phoneStatus:
                    attachment = new PhoneAttachment();
                    break;
                case CustomAttachmentType.score:
                    attachment = new ScoreAttachment();
                    break;
                case CustomAttachmentType.lianmai:
                    attachment = new LianmaiAttachment();
                    break;
                default:
