...
import com.netease.nim.uikit.business.session.activity.my.view.MarqueeTextView;
...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private MarqueeTextView topMsgTv;
    /**
     * 命令消息接收观察者
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        topMsgTv = (MarqueeTextView) findViewById(R.id.topMsgTv);
...
//                finish();
        ...
        NimUIKit.setSessionListener(new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                GoSettingEvent goSettingEvent = new GoSettingEvent(sessionId);
                goSettingEvent.setGoAnchorInfo(true);
                EventBus.getDefault().post(goSettingEvent);
            }
    ...
    public void setTopMstView(String msg) {
        if (TextUtils.isEmpty(msg)) {
            return;
        }
        topMsgTv.setText(msg);
    }
