...
public class AdvancedTeamInfoActivity extends UI implements TAdapterDelegate, TeamMemberAdapter.AddMemberCallback,
    ...
    private static final int REQUEST_CODE_TRANSFER_AND_QUIT = 105;
    ...
    private MenuDialog muteAllTeamMemberDialog;
    ...
    private View layoutMuteAllTeamMember;
    ...
    private TextView muteAllTeamMemberText;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_TRANSFER:
                final ArrayList<String> transferTarget = data.getStringArrayListExtra(ContactSelectActivity.RESULT_DATA);
                if (!CollectionUtil.isEmpty(transferTarget)) {
                    transferTeam(transferTarget.get(0), false);
                }
                break;
            case REQUEST_CODE_TRANSFER_AND_QUIT:
                final ArrayList<String> transferAndLeaveTarget = data.getStringArrayListExtra(ContactSelectActivity.RESULT_DATA);
                if (!CollectionUtil.isEmpty(transferAndLeaveTarget)) {
                    transferTeam(transferAndLeaveTarget.get(0), true);
                }
                break;
    ...
    protected void onDestroy() {
        ...
        if (muteAllTeamMemberDialog != null) {
            muteAllTeamMemberDialog.dismiss();
        }
     ...
     * 禁言所有普通群成员初始化
     */
    private void findLayoutMuteAllTeamMember() {
        layoutMuteAllTeamMember = findViewById(R.id.team_mute_all_team_member_layout);
        layoutMuteAllTeamMember.setVisibility(View.GONE);
        ((TextView) layoutMuteAllTeamMember.findViewById(R.id.item_title)).setText(R.string.team_mute_all_team_member);
        muteAllTeamMemberText = ((TextView) layoutMuteAllTeamMember.findViewById(R.id.item_detail));
        layoutMuteAllTeamMember.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                showMuteAllTeamMemberMenu();
            }
        });
    }
    ...
    private void updateTeamInfo(final Team t) {
        ...
        setMuteAllTeamMemberText(team.isAllMute());
    ...
    private void updateAuthenView() {
        if (isSelfAdmin || isSelfManager) {
            layoutMuteAllTeamMember.setVisibility(View.VISIBLE);
     ...
     * 从联系人选择器选择群转移对象
     *
     * @param quitTeam 转让后是否退出群聊
     */
    private void onTransferTeam(boolean quitTeam) {
        ...
        NimUIKit.startContactSelector(this, option, quitTeam ? REQUEST_CODE_TRANSFER_AND_QUIT : REQUEST_CODE_TRANSFER);
        dialog.dismiss();
    }
     ...
     * @param account 转让的帐号
     */
    private void transferTeam(final String account, final boolean quitTeam) {
        ...
        NIMClient.getService(TeamService.class).transferTeam(teamId, account, quitTeam).setCallback(
                new RequestCallback<List<TeamMember>>() {
                    ...
                    public void onSuccess(List<TeamMember> members) {
                        ...
                        ToastHelper.showToast(AdvancedTeamInfoActivity.this, quitTeam ? R.string.team_transfer_and_quit_success : R.string.team_transfer_success);
                    }

                    @Override
                    public void onFailed(int code) {
                        ToastHelper.showToast(AdvancedTeamInfoActivity.this, quitTeam ? R.string.team_transfer_and_quit_failed : R.string.team_transfer_failed);
    ...
    private void showRegularTeamMenu() {
        ...
        if (isSelfAdmin) {
            ...
            btnNames.add(getString(R.string.transfer_and_quit_team));
        ...
        dialog = new MenuDialog(this, btnNames, new MenuDialog.MenuDialogOnButtonClickListener() {
            ...
            public void onButtonClick(String name) {
                ...
                if (name.equals(getString(R.string.quit_team))) {
                    ...
                    onTransferTeam(false);
                } else if (name.equals(getString(R.string.transfer_and_quit_team))) {
                    onTransferTeam(true);
                }
                dialog.dismiss();
            }
    ...
    private void showMuteAllTeamMemberMenu() {
        if (muteAllTeamMemberDialog == null) {
            List<String> btnNames = TeamHelper.createMuteAllTeamMemberMenuStrings();
            int type = team.isAllMute() ? 0 : 1;
            muteAllTeamMemberDialog = new MenuDialog(AdvancedTeamInfoActivity.this, btnNames, type, 2,
                    new MenuDialog.MenuDialogOnButtonClickListener() {
                        ...
                        public void onButtonClick(String name) {
                            ...
                            Boolean mute = TeamHelper.isMuteAllTeamMember(name);
                            setMuteAllTeamMember(Boolean.TRUE.equals(mute));
                        }
                    });
        }
        muteAllTeamMemberDialog.show();
    }
    ...
    private void setMuteAllTeamMember(final boolean mute) {
        DialogMaker.showProgressDialog(this, getString(R.string.empty));
        NIMClient.getService(TeamService.class).muteAllTeamMember(teamId, mute).setCallback(
                new RequestCallback<Void>() {

                    @Override
                    public void onSuccess(Void param) {
                        DialogMaker.dismissProgressDialog();
                        setMuteAllTeamMemberText(mute);
                        ToastHelper.showToast(AdvancedTeamInfoActivity.this, R.string.update_success);
                    }

                    @Override
                    public void onFailed(int code) {
                        muteAllTeamMemberDialog.undoLastSelect(); // 撤销选择
                        DialogMaker.dismissProgressDialog();
                        ToastHelper.showToast(AdvancedTeamInfoActivity.this,
                                String.format(getString(R.string.update_failed), code));
                    }
    ...
    private void setMuteAllTeamMemberText(boolean mute) {
        muteAllTeamMemberText.setText(TeamHelper.getMuteAllTeamMemberString(mute));
    }
