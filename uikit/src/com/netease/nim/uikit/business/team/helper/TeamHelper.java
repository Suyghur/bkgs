...
public class TeamHelper {
    ...
    public static List<String> createMuteAllTeamMemberMenuStrings() {
        int[] res = new int[]{R.string.team_mute, R.string.team_no_mute, R.string.cancel};
    ...
    public static int getMuteAllTeamMemberString(boolean mute) {
        return mute ? R.string.team_mute : R.string.team_no_mute;
    }
    ...
    public static Boolean isMuteAllTeamMember(String name) {
