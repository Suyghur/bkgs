package com.pro.maluli.common.utils.glideImg;
...
public class GlideUtils {
    ...
    private static RequestOptions heardOptions = new RequestOptions()
            .placeholder(R.mipmap.ic_moren_head)
            .error(R.mipmap.ic_moren_head)
            .diskCacheStrategy(DiskCacheStrategy.ALL)
            .skipMemoryCache(true);
