...
public class OnTwoOneSocketEntity implements Serializable {
    ...
    public static class InfoBean implements Serializable {
        ...
        public List<?> getAppoint_list() {
            return appoint_list;
        }

        public void setAppoint_list(List<?> appoint_list) {
