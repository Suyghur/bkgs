...
public class VerifyEditText extends EditText {
    ...
    public VerifyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineColor = typedArray.getColor(R.styleable.VerifyEditText_lineColor, getColor(R.color.mainlan));
        textColor = typedArray.getColor(R.styleable.VerifyEditText_textColor, getColor(R.color.mainlan));
        typedArray.recycle();
        initView();
    }
    ...
    private void initView() {
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                KeyboardUtils.showSoftInput(VerifyEditText.this);
