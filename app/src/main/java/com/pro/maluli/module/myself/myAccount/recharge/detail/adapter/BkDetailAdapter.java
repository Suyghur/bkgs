package com.pro.maluli.module.myself.myAccount.recharge.detail.adapter;
...
public class BkDetailAdapter extends BaseQuickAdapter<BKRecordEntity.ListBean, BaseViewHolder> {
    List<BKRecordEntity.ListBean> datas;
    private Context context;

    public BkDetailAdapter(List<BKRecordEntity.ListBean> data, Context context1) {
