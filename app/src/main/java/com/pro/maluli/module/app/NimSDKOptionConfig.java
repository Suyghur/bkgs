...
//        options.authProvider = new DemoAuthProvider();
        options.enableRecentContactsTimeIndex = UserPreferences.isEnableRecentContactsTimeIndex();

//        SecondTimeoutConfig secondTimeoutConfig = new SecondTimeoutConfig();
//        secondTimeoutConfig.sendMessageSecondTimeout = 15000;
//        options.secondTimeoutForSendMessage = secondTimeoutConfig;
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationSmallIconId = R.mipmap.ic_app_logo;
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.c_3a9efb);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.pro.maluli/raw/sould";
