package com.pro.maluli.module.P2P;
...
public class MyP2PMessageActivity extends BaseMessageActivity {
    ...
    protected void showCommandMessage(CustomNotification message) {
        ...
        try {
            ...
            if (id == 1) {
                // 正在输入
                ToastHelper.showToastLong(MyP2PMessageActivity.this, "对方正在输入...");
            } else {
                ToastHelper.showToast(MyP2PMessageActivity.this, "command: " + content);
            }
